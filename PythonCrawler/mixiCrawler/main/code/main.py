...
def start( _id):
	...
	#设置动态ip（学长你重点看看使用代理ip下载的过程，我怀疑是这里除了问题）
	...
	try:
		...
		if  div is None:
			...
			if leftbox is not None:
				...
				public = handle_url(links, _id, proxy)
...
if __name__ == '__main__':
	...
	count = 737
	_id = 1939
	while cookies is not None and _id < 1000 * 1000:
		'''
		time.sleep(3)
		_id = int(_id) + 1
		start(_id)
